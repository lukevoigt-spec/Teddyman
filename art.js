...
const UICONS={
  ...
  /* CHEVRON — forward "continue/next" arrow (replaces the ➜ glyph); inherits the button's text colour */
  ...
  /* PLAY — solid forward triangle (replaces the ▶ glyph on the title/rest buttons); inherits text colour */
